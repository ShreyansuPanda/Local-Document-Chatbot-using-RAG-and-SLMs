...
Answer:"""
    ...
    "mistral": {
        ...
        Provide a clear and concise response. In case specified to use internet, use the internet to find the answer to answer the question.
...
class DocumentQASystem:
    ...
    def answer_question(self, question: str) -> dict:
        ...
        try:
            ...
            result = self.qa_chain({"query": corrected_question.lower()})
